...
public class IncomeController extends HttpServlet {
    ...
    public void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        var income = new Income(
                ...
                new CategoryDaoImpl().getById(Integer.parseInt(req.getParameter("category-income"))),
                new SubcategoryDaoImpl().getById(Integer.parseInt(req.getParameter("subcategory-income"))),
